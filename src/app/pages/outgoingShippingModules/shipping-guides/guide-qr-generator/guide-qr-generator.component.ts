...
@Component({
  selector: "vex-guide-qr-generator",
  templateUrl: "./guide-qr-generator.component.html",
  styleUrls: ["./guide-qr-generator.component.scss"],
})
export class GuideQrGeneratorComponent implements OnInit {
