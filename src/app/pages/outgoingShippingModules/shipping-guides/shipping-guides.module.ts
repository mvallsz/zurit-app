...
import { ShippingGuidesRoutingComponent } from "./shipping-guides-routing.component";
...
import { GuidesCreateUpdateModule } from "./guides-create-update/guides-create-update.module";
...
@NgModule({
  ...
  imports: [
    CommonModule,
    ShippingGuidesRoutingComponent,
    PageLayoutModule,
    FlexLayoutModule,
    BreadcrumbsModule,
