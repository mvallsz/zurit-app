...
import { GuideCreateUpdateBRoutingComponent } from './guides-create-update-b-routing.component';
import { PageLayoutModule } from 'src/@vex/components/page-layout/page-layout.module';
@NgModule({
  declarations: [GuidesCreateUpdateBComponent],
  imports: [
    CommonModule,
    PageLayoutModule,
    GuideCreateUpdateBRoutingComponent,
    MatSnackBarModule,
    MatIconModule,
    MatTableModule,
    ReactiveFormsModule,
...
export class GuidesCreateUpdateBModule {
