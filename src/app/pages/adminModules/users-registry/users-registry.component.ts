...
import icUser from "@iconify/icons-ic/twotone-account-circle";
...
import { userStatus } from "src/static-data/tlcargo-static-data";
...
const userFilters = environment.users_filters;

@UntilDestroy()
@Component({
  selector: 'vex-users-registry',
  templateUrl: './users-registry.component.html',
  styleUrls: ['./users-registry.component.scss'],
...
export class UsersRegistryComponent implements OnInit, AfterViewInit {
