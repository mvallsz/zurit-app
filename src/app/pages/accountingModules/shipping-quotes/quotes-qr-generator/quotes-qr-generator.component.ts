...
@Component({
  selector: "vex-quotes-qr-generator",
  templateUrl: "./quotes-qr-generator.component.html",
  styleUrls: ["./quotes-qr-generator.component.scss"],
})
export class QuotesQrGeneratorComponent implements OnInit {
