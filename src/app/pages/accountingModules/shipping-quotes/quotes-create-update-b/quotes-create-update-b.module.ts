...
import { QuotesCreateUpdateBRoutingComponent } from './quotes-create-update-b-routing.component';
import { PageLayoutModule } from 'src/@vex/components/page-layout/page-layout.module';

@NgModule({
  declarations: [QuotesCreateUpdateBComponent],
  imports: [
    CommonModule,
    PageLayoutModule,
    QuotesCreateUpdateBRoutingComponent,
    MatSnackBarModule,
    MatIconModule,
    MatTableModule,
    ReactiveFormsModule,
...
export class QuotesCreateUpdateBModule {
